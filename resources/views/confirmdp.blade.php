    ...
    <div class="flex justify-center h-full items-center">
        <div class="w-[626px]  h-[587px] bg-white rounded-2xl">
            ...
            <div class="flex justify-end">
                <a class="mr-8 mt-4" href="/downpayment">
            ...
            <div class="px-[86px]">
                ...
                <p class="text-3xl text-center mt-12  text-[#201A17] font-medium">Pembayaran down payment berhasil. Jangan lupa untuk membayar pelunasan maksimal 7 hari sebelum acara.</p>
                </div>
            </div>
        </div>
    </div>
