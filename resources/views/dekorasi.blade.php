...
<head>
    ...
    <title>Dekorasi | WeddingLy</title>
</head>
    ...
    <div class="flex h-screen">
        ...
        <div class="w-[468px] bg-[#F4E7E6]">
            ...
            <div class="flex flex-col items-center mt-8 justify-center gap-5">
                ...
                <a
                 href="#"
                    class="bg-gray-300 rounded-full w-[270px] h-12 hover:animate-shake cursor-not-allowed flex items-center justify-center mx-auto">Decoration</a>
            </div>
        </div>
        ...
        <div class="flex-1 mx-[150px] my-12 bg-white">
            ...
            <div class="grid grid-cols-5 mx-0 mt-16 gap-12">
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek1.jpg') }}" alt="Custom Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Custom Decoration</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek2.webp') }}" alt="Lantern Theme Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Lantern Theme Decoration</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek3.jpg') }}" alt="Color Based Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Color Based Decoration</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek4.jpeg') }}" alt="Arbor Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Arbor Decoration</p>
                            <p class="text-[10px] text-black font-semibold">Rp 4.000.000</p>
                        </div>
                        <div class="absolute -right-3 -top-3">
                            <img src="img/Keranjang.svg" alt="">
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek5.jpg') }}" alt="Stage Backdrop Only">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Stage Backdrop Only</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek6.webp') }}" alt="Royal Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Royal Decoration</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek7.jpg') }}" alt="Rustic Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Rustic Decoration</p>
                            <p class="text-[10px] text-black font-semibold">Rp 4.000.000</p>
                        </div>
                        <div class="absolute -right-3 -top-3">
                            <img src="img/Keranjang.svg" alt="">
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek8.png') }}" alt="Maximalism Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Maximalism Decoration</p>
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek9.jpg') }}" alt="Wedding Altar Only">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Wedding Altar Only</p>
                            <p class="text-[10px] text-black font-semibold">Rp 2.000.000</p>
                        </div>
                        <div class="absolute -right-3 -top-3">
                            <img src="img/Keranjang.svg" alt="">
                ...
                <div class="col-span-1">
                    <div class="bg-gray-100 w-[132px] relative rounded-2xl h-[154px]">
                        <img class="rounded-3xl object-center w-[132px] h-[154px]"
                            src="{{ asset('dek10.webp') }}" alt="Minimalist Decoration">
                        <div class="text-center flex-col flex justify-center">
                            <p class="text-[10px] font-light">Minimalist Decoration</p>
                            <p class="text-[10px] text-black font-semibold">Rp 2.000.000</p>
                        </div>
                        <div class="absolute -right-3 -top-3">
                            <img src="img/Keranjang.svg" alt="">
