...
<body>
    <div class="mx-[129px]">
        <div class="flex items-center flex-row gap-20">
            <img src="{{ asset('WeddingLy.png') }}" onclick="location.href = '/katalog'" alt="WeddingLy">
        ...
        <div class="flex mt-4 flex-row gap-11">
            ...
            <a class="hover:font-semibold hover:underline hover:underline-offset-2 cursor-pointer" href="/pelunasan">
                Pelunasan
            </a>
        </div>
        <div class="w-full rounded-xl ring-1 mt-6 ring-black">
            <div class="m-4">
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <div class="flex flex-row justify-end">
                        <h1 class="w-[158px] font-semibold">DP 50%</h1>
                        <p>IDR 4.000.000</p>
                    </div>
                    <div class="self-end my-8">
                    <a class="w-[193px] flex items-center justify-center font-medium h-[40px] bg-[#CEAAAA] rounded-lg" href="/bayardp">
                        Bayar DP Sekarang
                    </a>
                    </div>
                </div>
