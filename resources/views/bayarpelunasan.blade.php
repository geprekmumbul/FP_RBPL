        ...
        <div class="w-[626px] h-[587px] bg-white rounded-2xl">
            ...
            <div class="flex justify-between">
                <div class="flex mx-auto translate-x-4 text-center ">
                    <img class="w-[142px]" src="{{ asset('WeddingLy.png') }}" alt="">
                </div>
                <a class="mr-4 mt-4" href="/konfirmasipelunasan">
            ...
            <div class="px-[86px]">
                ...
                <div class="flex flex-row justify-between">
                    <p class="font-semibold">Pelunasan 50%</p>
