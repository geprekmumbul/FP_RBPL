...
<head>
    ...
    <title>Down Payment | WeddingLy</title>
</head>
        ...
        <div class="w-full rounded-xl ring-1 mt-6 ring-black">
            <div class="m-4">
                ...
                <div class="flex flex-col mt-5">
                    ...
                    <div class="flex flex-row justify-end">
                        <h1 class="w-[158px] font-semibold">Pelunasan 50%</h1>
                        <p>IDR 4.000.000</p>
                    </div>
                    <div class="self-end my-8">
                    <a class="w-[193px] flex items-center justify-center font-medium h-[40px] bg-[#CEAAAA] rounded-lg" href="/bayarpelunasan">
                        Bayar Pelunasan
                    </a>
                    </div>
                </div>
