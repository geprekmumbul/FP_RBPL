...
<head>
    ...
    <title>Konfirmasi Pelunasan</title>
</head>
    ...
    <div class="flex justify-center h-full items-center">
        <div class="w-[626px]  h-[587px] bg-white rounded-2xl">
            ...
            <div class="flex justify-end">
                <a class="mr-8 mt-4" href="/pelunasan">
            ...
            <div class="px-[86px]">
                <div class="flex justify-center flex-col items-center mt-12">
                    ...
                    <p class="text-4xl text-center mt-20  text-[#201A17] font-medium">Pembayaran pelunasan berhasil.
